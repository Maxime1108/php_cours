...
$errors = []; // Initialisation d'un tableau vide pour les erreurs
...
if (isset($_POST['submit_form'])) 
    ...
    if (empty($_POST['telephone']) || !preg_match('/^\d{10,20}$/', $_POST['telephone'])) {
        $errors[] = "Le numéro de téléphone doit contenir uniquement des chiffres et avoir entre 10 et 20 caractères.";
    }
